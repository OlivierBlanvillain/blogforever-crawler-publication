...
The functions \coderef{allrulesAlgo}, \code{Apply} and \coderef{similarityAlgo} (as \code{ScoreFunction}) being defined, the definition of \autoref{extractionAlgo} for article extraction is complete. We now proceed with a time complexity analysis.
