...
\begin{enumerate}[noitemsep]
  ...
  \item Download media\comment{as before, media is rather a concept. Should we replace with multimedia files?}
...
\end{equation*}
%
where $\URL$, $\DATE$ and $\RECORD$ are respectively the set of all URLs, dates and records, and $\mathcal{P}$ designates the powerset operator. By delegating all shared mutable state to the back end system (Invenio's database)\comment{this is the 1st mention of Invenio. Make sure to mention in the Introduction, or remove from here as well.}, web crawler instances can be added, removed and used interchangeably.
