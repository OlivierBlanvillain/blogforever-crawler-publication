...
% setup
Our measurements were made with garbage collector disabled on a otherwise idle core of an \TODO{Intel X} processor. Experimental data where obtained by taking the median of 11 mesurements. confidence intervals .. in .. as (max 0.002 sec)
