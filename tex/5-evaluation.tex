...
Our measurements were made with garbage collector disabled on a otherwise idle core of a \TODO{Intel X} processor.  asdjf élaksd jfélkas jfélkas jfélaskjd félakjd fékas jfdéasdj féaksd jf


% rtime eval, scalability with size of blogs
