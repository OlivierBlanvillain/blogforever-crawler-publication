...
\TODO{
  After writing the first sentece, you should write what are our aims in this work. (keep it in the same paragraph).\\
  \\
  Our main objective in this work are to create better algorithms and techniques for blog content extraction. (maybe you want to write something extra here+++, then, continue with the contributions:\\
  \\
  Our contributions can be summarised as follows:
}

We present the BlogForever Crawler, a key component of the BlogForever platform \cite{kasioumis2013towards} responsible for traversing blogs, extracting their content and monitoring their updates. Our contributions can be summarized as follows:
