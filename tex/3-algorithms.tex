...
% In the case the reader does not know how to read pseudocode
...
% abs, plan
Most functions in algorithm \ref{extractionAlgo} are voluntarily abstract at this point and will be explained in details in the remaining of this section. \ref{extractionrulesandstringsimilarity}, \ref{timecomplexityandlinearreformulation}, \ref{variationsforauthorsdatesandcomments}
