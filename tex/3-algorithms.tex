...
% into: algo 1 defined
The functions \coderef{allrulesAlgo}, \code{Apply} and \coderef{similarityAlgo} (as the \code{ScoreFunction}) being defined, the definition of \autoref{extractionAlgo} for article extraction is completed. We now proceed with a time complexity analysis.
